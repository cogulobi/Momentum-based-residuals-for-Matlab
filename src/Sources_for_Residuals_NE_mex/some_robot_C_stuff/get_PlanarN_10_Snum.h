...
/**
 * @file get_PlanarN_10_Snum.h
 * @brief Numerical computation of the Coriolis matrix S for a 10-DOF Planar robot
 *
...
/* End of code generation (get_PlanarN_10_Snum.h) */
